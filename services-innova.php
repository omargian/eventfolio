<?php
/**
* Template Name: servicios-innova
*/
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-12 text-center">
            <h2>#INNOVACIÓN</h2>
            <p>Odio et unde deleniti. Deserunt numquam exercitationem. Officiis quo odio sint voluptas consequatur ut a odio voluptatem.</p>
        ...
        <div class="row gy-4">
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative globo-item">
              ...
              <h4><a href="" class="stretched-link">Globos Neón</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative mask-item">
              ...
              <h4><a href="" class="stretched-link">3D Mask</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative deco-item">
              ...
              <h4><a href="" class="stretched-link">Deco Neón</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex">
            <div class="service-item position-relative wall-item">
              ...
              <h4><a href="" class="stretched-link">Living Walls</a></h4>
