      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Nosotros</h2>
            <p>Somos un grupo de talento mexicano con mucha garra, volcado en la creación de experiencias tecnológicas basadas en innovación digital, iluminación, arte y diseño.</p>
            <a class="cta-btn" href="<?php echo get_permalink(32) ?>">Contacto</a>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="https://giantec.test/giantec/neontt/wp-content/uploads/2023/05/NIK2497_1-scaled.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-5 content">
            <h2>Neon Tiki Tiger</h2>
            <p class="fst-italic py-3">
            Independiente del tipo de persona o de marca, nuestro reto siempre será lograr que vivas un momentazo digno de ser recordado, soñado y tal vez así, logremos distraerte un poco de este mundo tan efímero.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
    ...
    <section id="testimonials" class="testimonials">
      <div class="container">
        ...
        <div class="section-header">
          <h2>Artistas</h2>
          <p>Experiencias ejecutadas por artistas profesionales.</p>
        </div>
